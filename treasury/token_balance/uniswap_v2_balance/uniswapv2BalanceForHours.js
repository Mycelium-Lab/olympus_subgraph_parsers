...
export async function getUniswapV2BalanceByHour(
    startTimestamp = 0,
    endTimestamp = Date.now() / 1000
) {
    try {
        return fillBigArrayForHours(
            reformToBigArrayForHours(
                await getUniswapV2BalanceByHoursFromGraph()
            ),
            startTimestamp,
            endTimestamp
        )
...
export async function getUniswapV2BalanceBy4Hour(
    startTimestamp = 0,
    endTimestamp = Date.now() / 1000
) {
    try {
